class QuizSettings {
    constructor(settingsExternal) {
        ...
        this.settings = {
            ...
            selected_word_set_description: settingsExternal.selected_word_set_description,
    ...
    init() {
        ...
        this.loadWordSets(this.settings.word_set, this.settings.selected_word_set_description);  // Load WordSets options
    }
